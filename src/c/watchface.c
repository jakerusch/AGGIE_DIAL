...
static void main_window_load(Window *window) {
  ...
  text_layer_set_background_color(s_date_text_layer, BACKGROUND_COLOR);
  text_layer_set_text_color(s_date_text_layer, FONT_COLOR);
  ...
  text_layer_set_background_color(s_temp_layer, BACKGROUND_COLOR);
  text_layer_set_text_color(s_temp_layer, FONT_COLOR);
